...
// 本程序使用Velodyne点云结构 // Use the Velodyne point format as a common representation
...
public:
    ...
    */
    bool cachePointCloud(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
    {
        ...
        {
            // 转换成Velodyne格式 // Convert to Velodyne format
        ...
        // 存在无效点，Nan或者Inf // check dense flag
        ...
        // 检查是否存在ring通道，注意static只检查一次 // check ring channel
    ...
    */
    bool deskewInfo()
    {
        ...
        // 要求imu数据包含激光数据，否则不往下处理了 // make sure IMU data available for the scan
    ...
    */
    void imuDeskewInfo()
    {
        ...
        for (int i = 0; i < (int)imuQueue.size(); ++i)
        {
            ...
            // 提取imu姿态角RPY，作为当前lidar帧初始姿态角 // get roll, pitch, and yaw estimation for this scan
            ...
            // 提取imu角速度 // get angular velocity
            double angular_x, angular_y, angular_z;
            imuAngular2rosAngular(&thisImuMsg, &angular_x, &angular_y, &angular_z);

            // imu帧间时差 // integrate rotation
    ...
    */
    void odomDeskewInfo()
    {
        ...
        // 提取当前激光帧起始时刻的imu里程计 // get start odometry at the beinning of the scan
        ...
        // 用当前激光帧起始时刻的imu里程计，初始化lidar位姿，后面用于mapOptmization // Initial guess used in mapOptimization
    ...
    */
    PointType deskewPoint(PointType *point, double relTime)
    {
        ...
        // 当前时刻激光点与第一个激光点的位姿变换 // transform points to start
    ...
    */
    void projectPointCloud()
    {
        ...
        // 遍历当前帧激光点云 // range image projection
    ...
    */
    void cloudExtraction()
    {
        // 有效激光点数量
        int count = 0;
        // 遍历所有激光点 // extract segmented cloud for lidar odometry
        for (int i = 0; i < N_SCAN; ++i)
        {
            ...
            for (int j = 0; j < Horizon_SCAN; ++j)
            {
                ...
                {
                    // 记录激光点对应的Horizon_SCAN方向上的索引 // mark the points' column index for marking occlusion later
                    cloudInfo.pointColInd[count] = j;
                    // 激光点距离 // save range info
                    cloudInfo.pointRange[count] = rangeMat.at<float>(i,j);
                    // 加入有效激光点 // save extracted cloud
